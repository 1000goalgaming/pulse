...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=1VRuKSuYK8eOIW_5Mhm2LEUG0qF5hBC2S", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=1Kpj4AoF9fNEH77sTEOSbp_wodZz5M6qy", cache_dir=cache_dir, verbose=verbose) as f:
